...
1. **Determine Scope**:
   ...
   - **Installable skills**: Use `npx skills add https://docs-url` (Vercel's skills CLI) to install external skills.
2. **Scaffold Skill**:
...
| Installable | `npx skills add https://docs-url` | Vercel's skills CLI for fetching external skills |
