...
- **Shallow clones**: GitHub Actions often checks out repositories as shallow clones (limited history). See the `git` skill for detection and unshallowing procedures.
