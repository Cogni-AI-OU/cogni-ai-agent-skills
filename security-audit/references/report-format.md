...
Use this template for all `/security-audit` output. Generated during Step 7.
...
| **MEDIUM** | Vulnerability likely exists but depends on runtime context or call path the agent couldn't fully trace. |
