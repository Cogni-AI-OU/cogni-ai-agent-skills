...
- **[security-review](security-review/SKILL.md)**: Commands, step-by-step procedures, and mechanical execution for
  performing deep security reviews, vulnerability assessments, and threat modeling
