...
- **[astro-cli](astro-cli/SKILL.md)**: Expert-level guide for using the Astro CLI to manage Astronomer Airflow deployments and APIs.
  You MUST load this skill when asked to use the `astro` command.
...
- **[llmstxt](llmstxt/SKILL.md)**: A proposal to standardise on using an /llms.txt file to provide information to help LLMs use a website at inference time.
